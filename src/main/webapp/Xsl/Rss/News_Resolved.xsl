...
<xsl:output method="html" encoding="ISO-8859-1" indent="no"/>
  ...
  <table class="treeview" id="theTableResolved">
      <tr>
          <td class="treeviewTopLeft"><IMG height="8px" width="8px" src="/resources/img/TreeView/b.gif"/></td>
      ...
      <tr>
          ...
          <td class="treeviewMain">
              <div id="theCellResolved">
                <!-- Boucle sur chanque element -->
                <xsl:for-each select="$item">
                  <!-- Date de publication de chaque element-->
                  <li/><b><xsl:value-of select='normalize-space(./pubDate)'/></b>:<s>
      ...
      <tr>
          ...
          <td class="treeviewBottomRight"><IMG height="8px" width="8px" src="/resources/img/TreeView/b.gif"/></td>
      </tr>
  </table>
