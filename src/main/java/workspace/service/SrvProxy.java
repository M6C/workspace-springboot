...
public class SrvProxy extends SrvGenerique {
        ...
        private static final Logger log = Logger.getLogger(SrvProxy.class.getName());
        ...
        private void returnHome(HttpServletRequest request, HttpServletResponse response) throws Exception{
        // Get the absolute path of the image
        ServletContext sc = request.getSession().getServletContext();
