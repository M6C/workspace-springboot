...
// Source File Name:   SrvSelectProjetDirFilePage.java

package workspace.service.common;
...
public class SrvSelectProjetDirFilePage extends SrvGenerique
{

    public SrvSelectProjetDirFilePage()
    {
    }
