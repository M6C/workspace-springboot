Ext.define('Workspace.poc.draganddrop.common.grid.GridFileExplorerExtjs4', {

	extend: 'Workspace.poc.draganddrop.common.grid.GridDragDropExtjs4'
	,
	...
	initComponent : function(){
		...
		var store = Ext.create('Workspace.poc.draganddrop.common.grid.data.StoreFileExplorer', {
...
}, function() {Workspace.tool.Log.defined('Workspace.poc.draganddrop.common.grid.GridFileExplorerExtjs4');});