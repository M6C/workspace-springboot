// NAMESPACE
Ext.ns('Workspace.Agile');

Workspace.Agile.Selection = function(input){
...
with({o: Workspace.Agile.Selection.prototype}){
o.setCaret = function(start, end){
var o = this.input;
if(Workspace.Agile.Selection.isStandard)
o.setSelectionRange(start, end);
else if(Workspace.Agile.Selection.isSupported){
...
new function(){
var d = document, o = d.createElement("input"), s = Workspace.Agile.Selection;
s.isStandard = "selectionStart" in o;
s.isSupported = s.isStandard || (o = d.selection) && !!o.createRange;
};
//http://www.highdots.com/forums/javascript/set-caret-cursor-position-iframe-283168.html
o.setCursor = function(st,end) {
	var el=this.input;
