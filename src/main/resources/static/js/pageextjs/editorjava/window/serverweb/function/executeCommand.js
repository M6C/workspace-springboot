// Function
Ext.define('Workspace.editorjava.window.serverweb.function.executeCommand', {

	statics: {
		execute : function(statusbarId, cmd) {
...
}, function() {Workspace.tool.Log.defined('Workspace.editorjava.window.serverweb.function.executeCommand');});