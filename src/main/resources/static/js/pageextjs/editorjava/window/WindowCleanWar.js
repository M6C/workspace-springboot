Ext.define('Workspace.editorjava.window.WindowCleanWar', {
	// REQUIRED
...
,
	title: 'Classpath',        //titre de la fen�tre
...
}, function() {Workspace.tool.Log.defined('Workspace.editorjava.window.WindowCleanWar');});