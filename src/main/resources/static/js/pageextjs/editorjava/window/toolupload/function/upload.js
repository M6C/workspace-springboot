// Function
Ext.define('Workspace.editorjava.window.serverweb.function.upload', {
...
}, function() {Workspace.tool.Log.defined('Workspace.editorjava.window.serverweb.function.upload');});