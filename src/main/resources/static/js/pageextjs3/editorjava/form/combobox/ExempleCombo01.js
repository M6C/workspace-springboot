/**
 * http://stackoverflow.com/questions/483591/extjs-combobox-not-selecting-by-valuefield-after-expand
 */
var ficheDataStore = new Ext.data.Store({
    id: 'ficheDataStore',
    autoLoad: true,
 ...
 * Exemple de data :
   {results:[
   		{"Nom":"cercle interieur"},
   		{"Observations":""},
   		{"Codes":" "},
   		{"Adresse":"dd"},
   		{"CompteurCommunes":"1"},
   		{"TagClient":"3-56"},
   		{"GUID":"443609c6-d064-4676-a492-7baa7b4288d1"},
   		{"AdresseFacturation":""},
   		{"CompteurCommunesFacturation":"1"}
   	]}
   	
   	{"results":[
	   	{ "Compteur" : "1","Localisation" : "6200  ST ISIDORE"},
	   	{ "Compteur" : "2","Localisation" : "21340 CHANGE"},
	   	{ "Compteur" : "3","Localisation" : "1200  ELOISE"},
	   	{ "Compteur" : "4","Localisation" : "1200  ST GERMAIN SUR RHONE"},
	   	{ "Compteur" : "5","Localisation" : "75000 PARIS"},
	   	{ "Compteur" : "6","Localisation" : "75001 PARIS 1ER ARRONDISSEMENT"}
   	]}
 */
